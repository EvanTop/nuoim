...
const siteOrigin = (process.env.ORIGIN || 'https://nuo.im').replace(/\/$/, '')
...
export default defineNuxtConfig({
  ...
  app: {
    ...
    // keepalive: true,
    head: {
      title: 'Nuo.im — 免费英语单词练习 | Free English Typing Practice', // default fallback title
      htmlAttrs: {
        lang: 'zh-CN',
      },
      meta: [
        ...
        //搜索引擎描述
        {
          name: 'description',
          content:
            'Nuo.im 官方网站 - 在线英语练习平台，支持单词跟打练习，提升英语学习效率，电脑上背单词。Practice English, one strike, one step forward',
        },
        //关键词（可选，搜索引擎基本不用，但能补充信息）
        {
          name: 'keywords',
          content:
            '电脑上背单词 , 英语打字练习, 单词跟打, 键盘练习, 英语学习, 打字练习软件, 单词记忆工具, 英语学习软件, 背单词神器, 英语肌肉记忆, 键盘工作者, 免费英语学习, 音标发音, 默写练习, 在线学英语, CET-4, CET-6, TOEFL, IELTS, GRE, GMAT, SAT, 考研英语, 专四专八, 程序员英语, JavaScript API, Node.js API, Java API, Linux命令, 编程词汇, 技术英语, VSCode插件, 开源项目, GitHub趋势榜, V2EX热搜, Gitee GVP, 少数派推荐, 英语打字训练, WPM统计, 准确率分析, 商务英语, BEC, 雅思听力, 日语学习, 多语言学习, 英语口语练习, 单词拼写训练',
        },
        { name: 'author', content: 'zyronon' },
        { name: 'robots', content: 'index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' },

        //Open Graph（用于社交媒体分享，微信/QQ/知乎/Facebook 等）
        { property: 'og:title', content: 'Nuo.im 官网 - 英语打字练习平台' },
        {
        ...
        { property: 'og:url', content: 'https://nuo.im/' },
        { property: 'og:image', content: 'https://nuo.im/imgs/og-image.png' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },

        // Twitter Card（用于 Twitter 分享）
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Nuo.im 官网 - 英语打字练习平台' },
        {
          name: 'twitter:description',
          content:
            'Nuo.im 官方网站 - 在线英语练习平台，支持单词跟打练习，提升英语学习效率，电脑上背单词。Practice English, one strike, one step forward',
        },
        { name: 'twitter:image', content: 'https://nuo.im/imgs/og-image.png' },
      ...
      link: [
        ...
        { rel: 'canonical', href: 'https://nuo.im/' },
      ...
      script: [
        {
          ...
          innerHTML: JSON.stringify({
            ...
            '@type': 'WebSite',
            name: 'Nuo.im',
            alternateName: ['Nuo.im', '词文记'],
            url: 'https://nuo.im/',
            sameAs: ['https://github.com/zyronon/typing-word'],
            potentialAction: {
              '@type': 'SearchAction',
              target: 'https://nuo.im/words?q={search_term_string}',
        ...
        },
        {
          ...
          innerHTML: JSON.stringify({
            ...
            url: 'https://nuo.im/',
            screenshot: 'https://nuo.im/imgs/og-image.png',
            offers: {
              '@type': 'Offer',
              price: '0',
              priceCurrency: 'USD',
  ...
  runtimeConfig: {
    public: {
      ...
      origin: process.env.ORIGIN || 'https://nuo.im',
      host: process.env.HOST || 'nuo.im',
